% 5*5 matrix
energyrange=linspace(-50,50,13);
energyspan=zeros(1,12);
%generating random matrix
for ii=1:10^7
systemstate=zeros(5,5);
 for i=1:5
     for j=1:5      
 spinstate=[1 -1]; 
...
normalizedenergyrenge=energyrange+((energyrange(1,10)-energyrange(1,9))/2);

%set lower and upper bound to -50 and 50
normalizedenergyrenge(13)=50;
energy=cat(2,-50,normalizedenergyrenge);
