...
print ('Migratory response to CTLA-4 and PD-1 Blockade)')
...
data[0] = open('df-25_xy4_1 posteriorMeanValues.txt')
data[1] = open('df-25_xy4_2 posteriorMeanValues.txt')
data[2] = open('df-25_xy4_3 posteriorMeanValues.txt')
data[3] = open('df-25_xy4_4 posteriorMeanValues.txt')
data[4] = open('df-25_xy4_5 posteriorMeanValues.txt')
data[5] = open('df-25_xy4_6 posteriorMeanValues.txt')
data[6] = open('df-25_xy5_1 posteriorMeanValues.txt')
data[7] = open('df-25_xy6_2 posteriorMeanValues.txt')
data[8] = open('df-25_xy6_3 posteriorMeanValues.txt')
...
fig.suptitle('CTLA-4+PD-1 Blockage', fontsize=12)
...
for j in range(0,3):
 for i in range(0,4):
     ...
     a=inset_axesP= inset_axes(ax[j,i], 
                    width="40%",
                    height=.3, 
                    loc=1)
...
ax[0,0].text(5, 3000, '#DFCI-25-4-1', fontsize=6,style='italic')
ax[0,1].text(5, 3000, '#DFCI-25-4-2', fontsize=6,style='italic')

ax[0,2].text(5, 3000, '#DFCI-25-4-3', fontsize=6,style='italic')
ax[0,3].text(5, 3000, '#DFCI-25-4-4', fontsize=6,style='italic')
ax[1,0].text(5, 3000, '#DFCI-25-4-5', fontsize=6,style='italic')
ax[1,1].text(5, 3000, '#DFCI-25-4-6', fontsize=6,style='italic')

ax[1,2].text(5, 3000, '#DFCI-25-5-1', fontsize=6,style='italic')
ax[1,3].text(5, 3000, '#DFCI-25-6-2', fontsize=6,style='italic')
ax[2,0].text(5, 3000, '#DFCI-25-6-3', fontsize=6,style='italic')
