...
print ('')
print ('Migratory response to PD-1 Blockade)')
...
data[0] = open('dfci27_xy1_1 posteriorMeanValues.txt')
data[1] = open('dfci27_xy1_2 posteriorMeanValues.txt')
data[2] = open('dfci27_xy1_3 posteriorMeanValues.txt')
data[3] = open('dfci27_xy2_1 posteriorMeanValues.txt')
data[4] = open('dfci27_xy3_1 posteriorMeanValues.txt')
data[5] = open('dfci27_xy4_1 posteriorMeanValues.txt')
data[6] = open('dfci27_xy5_1 posteriorMeanValues.txt')
data[7] = open('dfci27_xy6_1 posteriorMeanValues.txt')
data[8] = open('dfci27_xy7_1 posteriorMeanValues.txt')
data[9] = open('dfci27_xy8_1 posteriorMeanValues.txt')
data[10] = open('dfci27_xy10_3 posteriorMeanValues.txt')
data[11] = open('dfci27_xy11_1 posteriorMeanValues.txt')
...
### Application to simulated cell trajectories
...
fig.suptitle('PD-1 Blockage', fontsize=12)
...
for j in range(0,3):
 for i in range(0,4):
      ...
      ax[j,i].tick_params(axis='both', labelsize=6)
...
ax[0,0].text(5, 3000, '#DFCI-27-1-1', fontsize=6,style='italic')
ax[0,1].text(5, 3000, '#DFCI-27-1-2', fontsize=6,style='italic')

ax[0,2].text(5, 3000, '#DFCI-27-1-3', fontsize=6,style='italic')
ax[0,3].text(5, 3000, '#DFCI-27-2-1', fontsize=6,style='italic')
ax[1,0].text(5, 3000, '#DFCI-27-3-1', fontsize=6,style='italic')
ax[1,1].text(5, 3000, '#DFCI-27-4-1', fontsize=6,style='italic')

ax[1,2].text(5, 3000, '#DFCI-27-5-1', fontsize=6,style='italic')
ax[1,3].text(5, 3000, '#DFCI-27-6-1', fontsize=6,style='italic')
ax[2,0].text(5, 3000, '#DFCI-27-7-1', fontsize=6,style='italic')
ax[2,1].text(5, 3000, '#DFCI-27-8-1', fontsize=6,style='italic')
ax[2,2].text(5, 3000, '#DFCI-27-10-3', fontsize=6,style='italic')
ax[2,3].text(5, 3000, '#DFCI-27-11-3', fontsize=6,style='italic')
